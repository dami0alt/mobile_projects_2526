...
import 'package:movies/controllers/movies_search_controller.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Obx(
              (() => Get.find<MoviesSearchController>().isLoading.value
                  ? const CircularProgressIndicator()
                  : Get.find<MoviesSearchController>().foundedMovies.isEmpty
                      ? SizedBox(
                          width: Get.width / 1.5,
                          child: Column(
                            children: [
                      ...
                      : ListView.separated(
                          itemCount: Get.find<MoviesSearchController>()
                              .foundedMovies
                              .length,
                          shrinkWrap: true,
                          ...
                          itemBuilder: (_, index) {
                            Movie movie = Get.find<MoviesSearchController>()
                                .foundedMovies[index];
